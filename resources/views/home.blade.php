		...
		<div class="px-12 max-md:p-4 grid grid-cols-2 gap-16 w-full h-full max-md:grid-cols-1">
			...
			<div class="flex items-center justify-center w-full">
				<div class="w-fit h-fit grid grid-cols-2 gap-4">
					<div class="overflow-hidden rounded rotate-2 w-full aspect-4/3 flex items-center justify-center"><img class="w-full h-full object-cover" src="https://placehold.co/600x400?text=Hello+World"></div>
					<div class="overflow-hidden rounded rotate-2 w-full aspect-4/3 flex items-center justify-center"><img class="w-full h-full object-cover" src="https://placehold.co/600x400?text=Hello+World"></div>
					<div class="overflow-hidden rounded rotate-2 w-full aspect-4/3 flex items-center justify-center"><img class="w-full h-full object-cover" src="https://placehold.co/600x400?text=Hello+World"></div>
					<div class="overflow-hidden rounded rotate-2 w-full aspect-4/3 flex items-center justify-center"><img class="w-full h-full object-cover" src="https://placehold.co/600x400?text=Hello+World"></div>
				</div>
