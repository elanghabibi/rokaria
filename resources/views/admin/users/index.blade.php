<x-admin-layout title="Kelola User">
    <section class="space-y-4">
          ...
          <div class="flex gap-2">
            <a
              href="?"
              class="text-sm px-3 py-1 border-2 rounded-full {{ !request('role') ? 'text-sky-600 border-sky-200 bg-sky-100' : 'text-gray-600 border-gray-200 hover:bg-sky-100' }}"
              >Semua</a
            >
            <a
              href="?role=user"
              class="text-sm px-3 py-1 border-2 rounded-full {{ request('role') === 'user' ? 'text-sky-600 border-sky-200 bg-sky-100' : 'text-gray-600 border-gray-200 hover:bg-sky-100' }}"
              >User</a
            >
            <a
              href="?role=admin"
              class="text-sm px-3 py-1 border-2 rounded-full {{ request('role') === 'admin' ? 'text-sky-600 border-sky-200 bg-sky-100' : 'text-gray-600 border-gray-200 hover:bg-sky-100' }}"
              >Admin</a
            >
          </div>

          <div
            class="w-full bg-gray-50 rounded-lg shadow-sm border border-gray-200 overflow-hidden"
          >
            <div class="px-6 py-3">
              <form action="" method="POST">
                <div class="relative">
                  <i
                    class="bx bx-search absolute top-1/2 -translate-y-1/2 left-2 text-gray-600"
                  ></i>
                  <input
                    type="search"
                    name="search"
                      ...
                      <div class="flex justify-center gap-2">
                        ...
                        <div class="disclosure">
                          ...
                          >
                            ...
                            >
                              <i
                                class="bx bx-alert-triangle text-red-500 text-5xl"
                              ></i>
